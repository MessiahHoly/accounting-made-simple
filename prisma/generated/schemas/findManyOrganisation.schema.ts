...
export const OrganisationFindManySelectSchema: z.ZodType<Prisma.OrganisationSelect> = z.object({
...
export const OrganisationFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
...
export const OrganisationFindManySchema: z.ZodType<Prisma.OrganisationFindManyArgs> = z.object({ select: OrganisationFindManySelectSchema.optional(), include: z.lazy(() => OrganisationIncludeObjectSchema.optional()), orderBy: z.union([OrganisationOrderByWithRelationInputObjectSchema, OrganisationOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrganisationWhereInputObjectSchema.optional(), cursor: OrganisationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrganisationScalarFieldEnumSchema, OrganisationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OrganisationFindManyArgs>;

export const OrganisationFindManyZodSchema = z.object({ select: OrganisationFindManySelectSchema.optional(), include: z.lazy(() => OrganisationIncludeObjectSchema.optional()), orderBy: z.union([OrganisationOrderByWithRelationInputObjectSchema, OrganisationOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrganisationWhereInputObjectSchema.optional(), cursor: OrganisationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrganisationScalarFieldEnumSchema, OrganisationScalarFieldEnumSchema.array()]).optional() }).strict();